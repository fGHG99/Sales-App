...
const MapNavigation = () => {
      ...
      try {
        if (mapContainer.current && !map.current) {
          map.current = new maptilersdk.Map({
            ...
            center: [orderData.storeLocation.lng, orderData.storeLocation.lat], // longitude, latitude
            zoom: 15,
          });
          ...
          map.current.on("load", () => {
            ...
            const popup = new maptilersdk.Popup({ offset: 25 }).setHTML(`
                    ...
                    <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 14px;">${orderData.storeAddress}</p>
  ...
  const handleCallStore = () => {
    toast.info("Calling store...", {
      description: `Dialing ${order.storeName}`,
    });
  };
        ...
        <div>
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Navigate to {order?.storeAddress}
            </h1>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-700">
                        Pickup by:{" "}
                        {new Date(order.pickupBy).toLocaleTimeString([], {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                      </span>
