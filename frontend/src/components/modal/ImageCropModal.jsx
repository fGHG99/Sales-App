...
const ImageCropModal = ({ isOpen, onClose, imageSrc, onCropComplete }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl w-full max-h-[95vh] overflow-hidden bg-white border border-gray-200 shadow-xl">
        ...
        <div className="flex gap-6 py-6">
          {/* Main Crop Area - Now takes more space */}
          <div className="flex-1 min-w-0">
            <div className="flex justify-center">
              <div className="relative w-full max-w-2xl">
                <div className="aspect-square max-h-[500px] overflow-hidden rounded-lg border border-gray-200 shadow-sm bg-white">
                  {imageSrc && (
                    <ReactCrop
                      crop={crop}
          ...
          {/* Sidebar Panel - Reduced width and better responsive */}
