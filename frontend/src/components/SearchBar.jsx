...
const mockProducts = [
    ...
    { id: 2, name: "Laptop MacBook Pro 14" },
    { id: 3, name: "Smartphone Samsung Galaxy S23" },
    { id: 4, name: "Smartphone iPhone 15 Pro" },
    { id: 5, name: "Headphone Sony WH-1000XM5" },
    { id: 6, name: "Smartwatch Garmin Forerunner" },
    { id: 7, name: "TV LG OLED 55 inch" },
    { id: 8, name: "Mouse Logitech MX Master 3S" },
];
